...
window.handleDoctorAppointment = function(doctorName) {
    const confirmed = confirm(`Do you want to book an appointment with ${doctorName}? (Fee: ₹300-500)`);
    if (confirmed) {
        alert(`Appointment booked successfully with ${doctorName}! A warden will contact you.`);
    }
}
